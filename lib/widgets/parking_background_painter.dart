...
class ParkingBackgroundPainter extends CustomPainter {
  ...
  void _drawParkingPattern(Canvas canvas, Size size, Paint paint, Paint strokePaint) {
  ...
  void _drawCars(Canvas canvas, Size size, Paint paint, Paint strokePaint) {
    ...
    // Car 2 (middle left)
    _drawCar(canvas, Offset(size.width * 0.15, size.height * 0.4), 0.6, paint, strokePaint);
    
    // Car 3 (bottom area)
    _drawCar(canvas, Offset(size.width * 0.7, size.height * 0.7), 0.7, paint, strokePaint);
    
    // Car 4 (bottom left)
    _drawCar(canvas, Offset(size.width * 0.25, size.height * 0.8), 0.5, paint, strokePaint);
  }

  void _drawCar(Canvas canvas, Offset position, double scale, Paint paint, Paint strokePaint) {
  ...
  void _drawParkingSigns(Canvas canvas, Size size, Paint paint, Paint strokePaint) {
    // Large parking sign (top left)
    _drawParkingSign(canvas, Offset(size.width * 0.1, size.height * 0.08), 1.2, paint, strokePaint);
    
    // Medium parking sign (middle)
    _drawParkingSign(canvas, Offset(size.width * 0.5, size.height * 0.3), 0.8, paint, strokePaint);
    
    // Small parking sign (bottom right)
    _drawParkingSign(canvas, Offset(size.width * 0.85, size.height * 0.6), 0.6, paint, strokePaint);
  }

  void _drawParkingSign(Canvas canvas, Offset position, double scale, Paint paint, Paint strokePaint) {
  ...
  void _drawUrbanElements(Canvas canvas, Size size, Paint paint, Paint strokePaint) {
    // Trees
    _drawTree(canvas, Offset(size.width * 0.05, size.height * 0.2), 0.8, paint, strokePaint);
    _drawTree(canvas, Offset(size.width * 0.95, size.height * 0.15), 0.6, paint, strokePaint);
    
    // Buildings
    _drawBuilding(canvas, Offset(size.width * 0.1, size.height * 0.6), 0.7, paint, strokePaint);
    _drawBuilding(canvas, Offset(size.width * 0.9, size.height * 0.5), 0.9, paint, strokePaint);
  }

  void _drawTree(Canvas canvas, Offset position, double scale, Paint paint, Paint strokePaint) {
  ...
  void _drawBuilding(Canvas canvas, Offset position, double scale, Paint paint, Paint strokePaint) {

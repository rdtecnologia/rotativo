...
class ApiConfig {
  ...
  factory ApiConfig.fromJson(Map<String, dynamic> json) {
    return ApiConfig(
      ...
      autentica: json['autentica'] ?? '',
      transaciona: json['transaciona'] ?? '',
...
class ApiEnvironment {
  ...
  factory ApiEnvironment.fromJson(Map<String, dynamic> json) {
    return ApiEnvironment(
      dev: ApiConfig.fromJson(json['dev'] ?? {}),
      prod: ApiConfig.fromJson(json['prod'] ?? {}),
    );
  }

  ApiConfig getConfig(String environment) {
    return environment == 'dev' ? dev : prod;
  }
}